<template>
    <main-header />
    <BoxPr title="Casque" lien="/shop/Composants/Blocs-Alimentation" lienAcc=true> <img src="@/assets/images/Casque.png" class="image1"></BoxPr><br>
