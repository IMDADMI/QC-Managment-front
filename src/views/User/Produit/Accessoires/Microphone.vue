<template>
    <main-header />
    <BoxPr title="Microphone" lien="/shop/Accessoires/Microphone" lienAcc=true> <img src="@/assets/images/Microphone.png" class="image1"></BoxPr><br>
        ...
        handleResize() {
            ...
            axios.get('http://164.92.134.202:8099/api/product/allProduct').then((res) => {
                this.products = res.data.map((product) => {
                    if(product.productType=="Microphone"){
