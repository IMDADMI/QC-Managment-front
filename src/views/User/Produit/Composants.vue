<template>
    <main-header />
    <BoxPr title="Composants" lien="/shop/Composants"></BoxPr><br>
    <h3 id="Types">les Types des composants</h3>
    <div class="position">
...
export default {
    ...
    methods: {
        ...
        getAllTypes() {
            ...
            if(/Graphique/i.test(ProduitType) || /Ram/i.test(ProduitType) ||/mère/i.test(ProduitType)||/stockage/i.test(ProduitType)||/boitier/i.test(ProduitType)||/blocs/i.test(ProduitType)||/Processeur/i.test(ProduitType))
            return true;
            else 
            return false;
