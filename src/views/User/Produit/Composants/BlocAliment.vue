<template>
    <main-header />
    <BoxPr title="Blocs d'alimentation" lien="/shop/Composants/Blocs-Alimentation" lienComp=true> <img src="@/assets/images/Powersupply.png" class="image1"></BoxPr><br>
        ...
        handleResize() {
            ...
            axios.get('http://164.92.134.202:8099/api/product/allProduct').then((res) => {
                this.products = res.data.map((product) => {
                    if(product.productType=="Blocs d'alimentation"){
