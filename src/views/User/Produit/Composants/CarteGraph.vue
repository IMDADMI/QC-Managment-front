<template>
    <main-header />
    <BoxPr title="Carte graphique" lien="/shop/Composants/Carte-Graphique" lienComp=true> <img src="@/assets/images/CarteGraphique.png" class="image1"></BoxPr><br>
        ...
        handleResize() {
            ...
            axios.get('http://164.92.134.202:8099/api/product/allProduct').then((res) => {
                this.products = res.data.map((product) => {
                    if(product.productType=="Carte Graphique"){
