<template>
    <main-header />
    <BoxPr title="Processeurs" lien="/shop/Composants/Processeurs" lienComp=true> <img src="@/assets/images/Cpu.jpg" class="image1"></BoxPr><br>
        ...
        handleResize() {
            ...
            axios.get('http://164.92.134.202:8099/api/product/allProduct').then((res) => {
                this.products = res.data.map((product) => {
                    if(product.productType=="Processeur"){
