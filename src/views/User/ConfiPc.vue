<template>
    <main-header />
    <div class="titre">
        <h1><strong>Composez dès maintenant le PC de vos rêves !</strong></h1>
        <p>
            Avec notre configurateur de PC  simple et clair. SETUP  vous propose une large sélection de composants matériels PC de haute qualité et à jour qui sont parfaitement adaptés. Achetez maintenant votre PC individuel à un prix raisonnable.
        </p>
    </div>
...
<div class="panier_Carts">
    ...
    <div class="Carts_Comp" v-for="element in selectionType" :key="element" >
        ...
        <div class="total" v-if="element.type=='Total'">
            <table class="table table-striped table-hover">
                ...
                <thead>
                    <tr>
                        <th scope="col" colspan="3"><h4 style="color:var(--dark-blue)"><strong> Prix Total: </strong> </h4></th>
                        <th scope="col" colspan="3"><h4> {{this.product.productPrice}} MAD </h4></th>
                    </tr>
                </thead>
                </table>
                <button @click="acheter()" style="background: none;margin-top: 3%;margin-left: 100%;"><img src="@/assets/images/composant_PC_Server/Comp_Images/checkout.png" style="width: 40px;"> <p>Check</p></button>
        </div>
    ...
    <div class="panier" v-if="!this.typeFiltrage[8].clique==0">
    ...
    <ajoute-panier  @close-modal="closeModal" ProduitNom="Buy-Tech Configurateur PC" :quantite="quantity"    v-if="showModal"/>
...
export default{
    ...
    data() {
        return {
            ...
            ,product:{
                "productId":999998,
                "productName": "PC Configure",
                "productType": "PC-Bureau",
                "brand": "Buy-Tech PC",
                "model": "Buy-Tech version 2023",
                ...
                "image": "https://img-0.journaldunet.com/qpKv3rd5t7gg4wl2lKvxsTwQQRw=/1500x/smart/a1afcee6aacf47fc90ca1e62315de73f/ccmcms-jdn/16947297.jpg",
                "productPrice": 0,
            ...
            ,typeFiltrage:[
                ...
                },
                {
                    ...
                    type:"CheckOut",
                    image:require("@/assets/images/composant_PC_Server/Comp_Images/checkout.png"),
                    clique:-1
                },*/
       ...
       ,vider(type){
            ...
            for (let index = 0; index < this.configuration.length; index++) {
                if(this.configuration[index].compType==type){
                    this.product.productPrice=this.product.productPrice-this.configuration[index].compPrice
